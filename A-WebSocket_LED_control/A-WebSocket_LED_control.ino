...
const char *ssid = "35294";           // The SSID (name) of the Wi-Fi network you want to connect to
const char *password = "sveta.sasha"; // The password of the Wi-Fi network
...
{ // Try to connect to WiFi
  ...
  fadeToLevel(500, FADE_DELAY_FAST);
...
{ // When a WebSocket message is received
  ...
  case WStype_TEXT: // if new text data is received
    ...
    fadeToLevel(brightness, FADE_DELAY_FAST);
    break;
  }
}
